...
# =============================================================================
# W7 controls, RoPE side. Built on W6's helpers above, unchanged.
#   R12  every head's rotations off in blocks 6-11, in the intact model and after the 0-5
#        window: top-1 (5,000 images, per-image correctness saved) and SSDC per block; plus
#        shuffled rotations (rotations of a fixed random permutation of the patch positions:
#        same statistics, wrong position) against identity rotations.
#   C3   probes at blocks 4 and 11 with a train/val/test split (epoch chosen on val), with
#        row / column accuracy by distance to the image border; then the same with
#        patch-to-prefix attention blocked in every block.
# =============================================================================
import traceback
...
# ---------------- probes with a validation split (border and prefix tests) ----------------
class CapIn:
