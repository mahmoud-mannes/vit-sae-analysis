...
Scripts for the rotary-embedding experiments, W1-A to W6 in the order they were run. The main
...
and `w1b_supplementary.py` and `e12_dinov3_224.py` repeat it at 224.
...
- Relative to the scripts as run, only these were changed: file names, the source-root path
  ...
  `None`, since the scripts sit inside the repo), W1-A's input paths, and some log wording.
